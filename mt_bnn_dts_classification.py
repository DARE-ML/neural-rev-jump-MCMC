...
def main():
    ...
    for problem in range(19, 20):
        ...
        if problem == 8: #Wine Quality Red
            traindata = np.genfromtxt('/Users/megannguyen/Desktop/mt-bnn-dts-master/DATA/red-wine/ftrain.csv',delimiter=',')
            testdata = np.genfromtxt('/Users/megannguyen/Desktop/mt-bnn-dts-master/DATA/red-wine/ftest.csv',delimiter=',')
            ...
            hidden = 50
            output = 2
            moduledecomp = [6, 8, 11]  # number of inputs for each subtask
        if problem == 9: #IRIS
        ...
        if problem == 12: #Bank additional
            ...
            hidden = 100
            output = 2
            moduledecomp = [47, 49, 51]  # number of inputs for each subtask
        ...
        if problem == 16: 
            ...
            hidden = 50
            output = 2
            moduledecomp = [15, 17, 19]  # number of inputs for each subtask
        ...
        if problem == 17: 
            ...
            hidden = 24
            output = 2
            moduledecomp = [2, 5, 7]  # number of inputs for each subtask
        if problem == 18: 
        ...
        if problem == 21: 
            ...
            hidden = 20
            output = 2
            moduledecomp = [7, 9, 10]  # number of inputs for each subtask
