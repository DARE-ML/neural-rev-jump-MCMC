...
outres1 = open('mt_result_poker_inp2.txt', "a+")
...
def main():
    ...
    for problem in range(18, 19):
        ...
        if problem == 10: #Ionosphere
            ...
            hidden = 60
            output = 2
            moduledecomp = [30, 32, 34]  # number of inputs for each subtask
        ...
        if problem == 16: 
            ...
            hidden = 30
            output = 2
            moduledecomp = [8, 15, 19]  # number of inputs for each subtask
        ...
        if problem == 17: 
            ...
            hidden = 24
            output = 2
            moduledecomp = [3, 4, 7]  # number of inputs for each subtask
        if problem == 18: 
        ...
        if problem == 19: 
            ...
            hidden = 29
            output = 2
            moduledecomp = [5, 7, 8]  # number of inputs for each subtask
        ...
        if problem == 21: 
            ...
            hidden = 20
            output = 2
            moduledecomp = [5, 8, 10]  # number of inputs for each subtask
        ...
        for s in range(0, subtasks):
            ...
            np.savetxt(outres1, (posrmse_train[int(burnin):,s]))
            np.savetxt(outres1, (posrmse_test[int(burnin):,s]))
