...
outres1 = open('mt_result_hid1.txt', "a+")
...
#size of each subtask
    ...
    ## PROPOSE FOR PARAMS of MODEL M theta_m
        ...
        for i in range(1, samples-1):    # ---------------------------------------
            ...
            np.savetxt(outres1, (likelihood), fmt='%1.5f')
...
def main():
    ...
    for problem in range(2, 3):
        ...
        #         raise
        # outres = open(path + '/results.txt', 'w') #create file results.txt in new folder
        ...
        for s in range(0, subtasks):
            ...
            np.savetxt(outres1, (posrmse_train[:,s]), fmt='%1.5f')
            np.savetxt(outres1, (posrmse_test[:, s]), fmt='%1.5f')
        ...
        x2 = fx_high_tr2 - fx_low_tr2 # DIFF in posterior distr of subtask 3
