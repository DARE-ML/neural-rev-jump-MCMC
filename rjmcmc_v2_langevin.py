    ...
    def sampler(self, dims1, dims2, w_limit, eta_limit):
        ...
        for i in range(samples -1):
            if is_in_lower_dimension: #jump up dimension: netw1 < netw2
                ...
                v = np.random.normal(0, eta_limit, w_size2-w_size1)
                #--- Propose w
                ...
                log_v = self.v_jump(eta_limit, v, w_size2-w_size1)
                #--- Calc log posterior 
                log_posterior = (prior_proposal + likelihood_proposal) - (prior_current + likelihood_current + log_v) + diff_prop 
                try:
                ...
                log_posterior_down = (prior_current + likelihood_current + log_v) - (prior_proposal + likelihood_proposal) - diff_prop 
                try:
